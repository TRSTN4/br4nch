...
> ```python
> >>> br4nch.[duplicate.Tree](../functions/duplicate/duplicate_tree.md)(new_tree="MyBranch", target_tree="MyHeader", attributes=123)
...
> ```python
> >>> br4nch.[set.Size](../functions/set/set_size.md)(tree="MyTree", size="123")
...
[create.Tree](../functions/create/create_tree.md), [duplicate.Tree](../functions/duplicate/duplicate_tree.md), [load.Folder](../functions/load/load_folder.md), [replace.Tree](../functions/replace/replace_tree.md)
...
> ```python
> >>> br4nch.[set.Size](../functions/set/set_size.md)(tree="MyTree", size=21)
...
> ```python
> >>> br4nch.[load.Tree](../functions/load/load_tree.md)(tree_file="D:/ThisBranchFileIsNotValid")
...
> ```python
> >>> br4nch.[load.Tree](../functions/load/load_tree.md)(tree_file="D:/ThisBranchFileDoesNotExists", attributes_file="D:/ThisPackageFileIsNotValid")
...
> ```python
> >>> br4nch.[export.Tree](../functions/export/export_tree.md)(tree="MyTree", output_folder="D:ThisDirectoryDoesNotExists")
...
> ```python
> >>> br4nch.[load.Tree](../functions/load/load_tree.md)(tree_file="D:/ThisBranchFileDoesNotExists")
...
> ```python
> >>> br4nch.[load.Tree](../functions/load/load_tree.md)(tree_file="D:/br4nch-MyTree/tree-MyTree.br4nch", attributes_file="ThisPackageFileDoesNotExists!")
...
> ```python
> >>> br4nch.[set.Size](../functions/set/set_size.md)(tree="MyTree", size=2)
...
[create.Tree](../functions/create/create_tree.md), [duplicate.Tree](../functions/duplicate/duplicate_tree.md), [load.Folder](../functions/load/load_folder.md), [load.Tree](../functions/load/load_tree.md), [replace.Tree](../functions/replace/replace_tree.md)

**Example:**

> ```python
> >>> br4nch.[create.Tree](../functions/create/create_tree.md)(tree="MyTree", header="MyHeader")
...
> ```python
> >>> br4nch.[set.Symbol](../functions/set/set_symbol.md)(tree="MyTree")

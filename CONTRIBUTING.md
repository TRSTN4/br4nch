...
> If you want to ask a question, we assume that you have read the available [Documentation](https://br4nch.readthedocs.io/).
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment components/versions (Make sure that you have read the [documentation](https://br4nch.readthedocs.io/). If you are looking for support, you might want to check <a href="#I Have a Question">this section</a>).
...
- Make sure that you are using the latest version.
- Read the [documentation](https://br4nch.readthedocs.io/) carefully and find out if the functionality is already covered, maybe by an individual configuration.

...
def librarian(action):
    ...
    global branches, paint_package_branch, paint_package_header, paint_package_layer, output, symbols, uids, positions,\
        size
    ...
    if action:
        ...
        storage = [branches, paint_package_branch, paint_package_header, paint_package_layer, output, symbols, uids,
                   positions, size]

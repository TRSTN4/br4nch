...
from br4nch.utility.handler import MaximumPaintSlotsError
    ...
    for position in range(len(paint)):
        if paint[position]:
            paint[position] = ["\u001b[30m", "\u001b[31m", "\u001b[32m", "\u001b[33m", "\u001b[34m", "\u001b[35m",
                               "\u001b[36m", "\u001b[37m", "\u001b[1m", "\u001b[4m", "\u001b[4m",
                               "\u001b[0m"][["black", "red", "green", "yellow", "blue", "magenta", "cyan", "white",
                                             "bold", "underline", "reversing", "clear"].index(paint[position])]

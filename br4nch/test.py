# Beta phase - br4nch v1.2.1
# desc - Error handling 2/2 and added a new 'copy branch' script.
...
br4nch.set.paint.branch(branch="Database", paint=["blue", "bold"])
br4nch.set.paint.header(branch="Database", paint="cyan")
br4nch.set.paint.layer(branch="Database", paint=["green", "bold"], pos="*")
br4nch.set.paint.layer(branch="Database", paint=["red", "underline"], pos=["1.1.1", "2.2<3"])
br4nch.set.paint.layer(branch="Database", paint=["cyan", "underline"], pos="2.1.1.2.1")
br4nch.set.paint.layer(branch="Database", paint=["red", "underline"], pos="2.1.1.2.1")
br4nch.set.paint.layer(branch="Database", paint=["yellow", "bold"], pos=["2.1.2.1.1", "3.1.1"])
br4nch.set.paint.layer(branch="Database", paint=["red", "bold"], pos="2.1.2")
br4nch.set.paint.layer(branch="Database", paint=["blue", "underline"], pos="2.1.1")
br4nch.set.paint.layer(branch="Database", paint=["blue", "underline"], pos="2.1")
br4nch.set.paint.layer(branch="Database", paint=["red", "underline"], pos="2.2")
br4nch.set.paint.layer(branch="Database", paint=["yellow", "underline"], pos="2.3")
br4nch.set.paint.layer(branch="Database", paint=["green", "underline"], pos="2.4")
br4nch.set.paint.layer(branch="Database", paint=["yellow", "underline"], pos="1.2")
br4nch.set.paint.layer(branch="Database", paint=["green", "bold"], pos="1.2.2")

# Sets the size of the 'Test' branch.
br4nch.set.size(branch="Test", size=0)

# Displays all the current branches.

...
class ReplaceTree:
    ...
    def replace_tree(self):
        ...
        UtilityLibrarian.existing_uids[self.new_tree] = UtilityLibrarian.existing_uids.pop(self.target_tree)
        ...
        for index in list(UtilityLibrarian.existing_trees)[index:-1]:
            ...
            UtilityLibrarian.existing_uids[index] = UtilityLibrarian.existing_uids.pop(index)
